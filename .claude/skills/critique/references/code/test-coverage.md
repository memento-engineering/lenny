...
Where the Validation Plan names commands, run them against the branch.
...
introduces have negative tests.
...
### F
No tests added for net-new behavior, or `go test ./...` does not pass
