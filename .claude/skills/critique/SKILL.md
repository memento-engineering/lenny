...
2. Read `skills/critique/references/<rubric>.md` (the named rubric). Do **not** read any other file under `skills/critique/references/` except `output-schema.json` — peer rubric texts would anchor the grade on cross-rubric context this grader is not supposed to have.
