...
**Date:** 2026-06-15 · **Status:** findings + recommendation — direction confirmed with Nico (2026-06-15). This is **not** an autonomous register entry: the call was made together, so it does not belong in the [decision register](../decisions) (the AI-decision entries). The ratified **ADR 0003** gets written once the dartantic spike (lenny-7ey2) settles the structural end-state; until then this doc + the two beads carry it.
