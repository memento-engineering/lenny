...
/// boot lives in `integration_test/launch/launch_dual_e2e_test.dart`.
...
void main() {
  ...
  group('DualLaunchHandle.shutdown teardown order + ownership', () {
    ...
    // hook is exercised behind the env gate in
    // integration_test/launch/launch_dual_e2e_test.dart (T2).
