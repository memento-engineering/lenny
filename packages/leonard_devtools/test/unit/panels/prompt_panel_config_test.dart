...
void main() {
  test('PromptPanelConfig equality is value-based', () {
    final a = PromptPanelConfig(
      ...
      enabledExtensionNamespaces: {'router', 'dio'},
    );
    final b = PromptPanelConfig(
      ...
      maxTurns: 25,
      wallClockBudget: const Duration(minutes: 5),
      enabledExtensionNamespaces: {'dio', 'router'},
    );
  ...
  test('toJson round-trips through fromJson', () {
    ...
    expect(restored.enabledExtensionNamespaces, {'router', 'dio'});
  });
  ...
  test('fromJson uses defaults for missing fields', () {
    ...
    expect(cfg.enabledExtensionNamespaces, isEmpty);
  });
  ...
  test('toJson output contains no secret fields', () {
    final cfg = PromptPanelConfig(
      ...
      enabledExtensionNamespaces: const {},
    );
    final json = cfg.toJson();
  ...
  test('toLeonardConfig propagates budgets', () {
    final cfg = PromptPanelConfig(
      goal: 'log in',
      modelId: 'mlx',
      maxTurns: 25,
