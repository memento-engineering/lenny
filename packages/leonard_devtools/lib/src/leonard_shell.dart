import 'package:leonard_agent/leonard_agent.dart' show TrajectoryRecord;
...
///
/// Split out from `LeonardDevToolsExtension` so widget tests can pump
...
class LeonardShell extends StatefulWidget {
  LeonardShell({
    super.key,
...
class _LeonardShellState extends State<LeonardShell> {
  final GlobalKey<LeonardPanelHostState> _hostKey =
      GlobalKey<LeonardPanelHostState>();
  ...
  @override
  void didUpdateWidget(covariant LeonardShell oldWidget) {
      ...
      builder: (context, result, _) {
        return switch (result) {
          ...
          ManifestProbeBindingMissing() => const _BindingMissingBanner(
            message:
                'Binding not detected. Add LeonardBinding.ensureInitialized() to your app\'s main().',
          ),
