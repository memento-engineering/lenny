# Manual smoke checklist — leonard_devtools
...
7. Compare the timeline panel's TurnRecord shape against
   `dart run leonard_cli --goal "..." --model claude-sonnet-4-6`
...
with `LeonardBinding.ensureInitialized()` attached in Chrome DevTools).
