...
void main() {
  ...
  final String entrypoint = p.join(packageRoot, 'bin', 'exploration_cli.dart');

  group('exploration_cli smoke', () {
    test('--help exit 0 + AGENTS.md path', () async {
      ...
      expect(out, contains('exploration_cli/templates/AGENTS.md'));
...
String _findPackageRoot() {
  ...
  for (int i = 0; i < 8; i++) {
    ...
    if (pubspec.existsSync()) {
      ...
      if (contents.contains('name: exploration_cli')) {
        return dir.path;
      }
    }
