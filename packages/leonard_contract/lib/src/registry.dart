...
class _Entry {
  ...
  final LeonardExtension plugin;
  final ExtensionContext context;

  /// Set when [LeonardExtension.initialize] threw. Short-circuits every
...
/// passes `debugPrint`); pure-Dart hosts may pass `print` or a no-op.
class ExtensionRegistry {
  ExtensionRegistry({void Function(String message)? logger})
    : _log = logger ?? _noop;
