// packages/leonard_agent/test/vm_service/leonard_vm_service_fake_test.dart
...
/// [LeonardSession] + [ObservationPuller] — all under `dart test`
/// with no Flutter dependency.
library;

import 'package:leonard_agent/leonard_agent.dart'
    show LeonardConfig, LeonardSession;
...
void main() {
  group('LeonardVmServiceFake — dispatch', () {
  ...
  group('LeonardVmServiceFake — LeonardSession integration', () {
