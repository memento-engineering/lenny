...
class _RecordingVmService extends VmService {
  ...
  Future<Response> callServiceExtension(
    ...
    // Canned handshake so LeonardSession.start() can complete.
    return Response()
      ..json = <String, dynamic>{
...
void main() {
  ...
  test(
    'LeonardSession.fromVmService.end() leaves the borrowed VM alive',
    () async {
      final session = LeonardSession.fromVmService(vm, 'iso-1');
