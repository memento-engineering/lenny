...
/// [VmServiceClient] / [ExplorationSession] from an already-connected
...
void main() {
  ...
  test('ExplorationSession.fromVmService starts without vm_service_io',
      () async {
    final session =
        ExplorationSession.fromVmService(_FakeVmService(), 'iso-1');
