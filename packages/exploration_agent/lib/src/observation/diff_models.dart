...
class ObservationDiff {
  ...
  final Map<String, PluginDiff> plugins;
...
/// Sealed plugin diff; one of [PluginDiffStructured], [PluginDiffOpaque],
/// [PluginDiffAdded], [PluginDiffRemoved].
@immutable
sealed class PluginDiff {
  const PluginDiff();
  Map<String, dynamic> toJson();
}
...
class PluginDiffStructured extends PluginDiff {
  const PluginDiffStructured({
    required this.added,
...
/// `deltaFriendly`.
class PluginDiffOpaque extends PluginDiff {
  const PluginDiffOpaque({required this.previous, required this.current});
...
class PluginDiffAdded extends PluginDiff {
  const PluginDiffAdded({required this.current});
...
class PluginDiffRemoved extends PluginDiff {
  const PluginDiffRemoved({required this.previous});
