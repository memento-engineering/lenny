    ...
    test('produces the PRD §9.2 stability block shape', () {
      final StabilityMetadata sm = StabilityMetadata(
        ...
        pluginsBusy: const <PluginBusy>[
          PluginBusy('a', reason: 'navigating', estMs: 100),
          PluginBusy('b'),
        ],
      );
      ...
      expect(json['plugins_busy'], <Map<String, Object?>>[
        <String, Object?>{
          'namespace': 'a',
          'reason': 'navigating',
          'est_ms': 100,
