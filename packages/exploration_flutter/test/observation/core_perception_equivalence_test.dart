...
import 'package:exploration_flutter/src/observation/core_fragment.dart';
import 'package:exploration_flutter/src/observation/core_perception.dart';
...
File _goldenFile(String name) {
  ...
  for (final String prefix in <String>['', 'packages/exploration_flutter/']) {
