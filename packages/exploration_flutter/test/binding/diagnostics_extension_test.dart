...
/// `ExplorationBinding.ensureInitialized` call. Once a Flutter binding is
...
void main() {
  ...
  test('release-mode gating: extension is debug/profile-only', () {
    ...
    // well-defined.
    expect(_diagnosticsExt.startsWith('$kExplorationExtensionPrefix.core.'),
        isTrue);
    if (kReleaseMode) {
      expect(ExplorationBinding.ensureInitialized(plugins: const []), isNull);
    } else {
