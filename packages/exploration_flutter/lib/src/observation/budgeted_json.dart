...
const int kDefaultPluginBudgetBytes = 1024;

/// Total cap on the sum of per-plugin observation budgets, in bytes.
const int kPluginBudgetTotalCapBytes = 2048;
...
/// the cap.
Map<String, int> distributePluginBudgets(
  Map<String, int> requested,
  List<String> namespaces, {
  int defaultPer = kDefaultPluginBudgetBytes,
  int totalCap = kPluginBudgetTotalCapBytes,
}) {
