...
class ObservationRequest {
  const ObservationRequest({
    ...
    this.pluginBudgets = const <String, int>{},
    this.errorCursor,
  });
  ...
  /// proportionally (see `distributePluginBudgets`).
  final Map<String, int> pluginBudgets;
  ...
  factory ObservationRequest.fromJson(Map<String, dynamic> j) {
    ...
    final Map<String, int> pluginBudgets = _parsePluginBudgets(
      j['pluginBudgets'],
    );
  ...
  static Map<String, int> _parsePluginBudgets(dynamic raw) {
