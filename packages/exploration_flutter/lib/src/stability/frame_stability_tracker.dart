...
/// Mixin layered onto `SchedulerBinding` (via `ExplorationBinding`) that
...
mixin FrameStabilityTracker on SchedulerBinding {
  ...
  /// Wired by `ExplorationBinding.stabilityZoneSpec` via a
  ...
  /// microtask boundary.
  ///
  /// Internal to the `exploration_flutter` package — not exported. The
