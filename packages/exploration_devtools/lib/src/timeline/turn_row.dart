...
/// Distinct row variant for a `plugin_disabled` event. Surfaces the
/// affected namespace and reason between turn rows.
class PluginDisabledRow extends StatelessWidget {
  const PluginDisabledRow({super.key, required this.record});

  final PluginDisabledEvent record;
